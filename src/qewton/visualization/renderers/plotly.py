...
class PlotlyRenderer(Renderer):
    ...
    class MeshArtist(PlotlyArtist):
        ...
        @classmethod
        def create(cls, backend_figure, plot):
            vertices, cells, color = plot.evaluate()
        ...
        def update(self, backend_figure, plot):
            vertices, _, color = plot.evaluate()
    ...
    class MeshField2DArtist(PlotlyArtist):
        ...
        def update(self, backend_figure, plot):
            _, _, color = plot.evaluate()
            backend_figure.data[self.figure_idx].intensity = color
